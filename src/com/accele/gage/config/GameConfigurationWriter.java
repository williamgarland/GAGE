...
public class GameConfigurationWriter {
	...
	public void write() throws GAGEException {
		...
		props.setProperty("masterVolume", String.valueOf(config.getMasterVolume()));
		props.setProperty("masterPitch", String.valueOf(config.getMasterPitch()));
		props.setProperty("masterVolumeMuted", String.valueOf(config.isMasterVolumeMuted()));
		props.setProperty("textureWrapSParameter", String.valueOf(config.getTextureWrapSParameter().getNativeValue()));
		props.setProperty("textureWrapTParameter", String.valueOf(config.getTextureWrapTParameter().getNativeValue()));
		props.setProperty("textureMinFilterParameter", String.valueOf(config.getTextureMinFilterParameter().getNativeValue()));
		props.setProperty("textureMagFilterParameter", String.valueOf(config.getTextureMagFilterParameter().getNativeValue()));
		props.setProperty("generateTextureMipmaps", String.valueOf(config.shouldGenerateTextureMipmaps()));
		try {
